...
def create_docker_compose(args):
    ...
    client_configs = [
        {"mem_limit": "3g", "batch_size": 64, "cpus": 4, "learning_rate": 0.001},
        {"mem_limit": "6g", "batch_size": 256, "cpus": 3, "learning_rate": 0.01},
        {"mem_limit": "4g", "batch_size": 64, "cpus": 2, "learning_rate": 0.02},
        {"mem_limit": "5g", "batch_size": 128, "cpus": 3, "learning_rate": 0.01},
...
"""
  ...
  client{i}:
    ...
    build:
      context: .
      dockerfile: Dockerfile
    command: python client.py --server_address=server:8080  --client_id={i} --batch_size={config["batch_size"]} --learning_rate={config["learning_rate"]}
    deploy:
      resources:
        limits:
          cpus: "{(config['cpus'])}"
